  ...
  try {
    ...
    return NextResponse.json({
      ...
      call: {
        ...
        followUpAt: conv.follow_up_at ? new Date(String(conv.follow_up_at)).toISOString() : null,
        followUpSent: Boolean(conv.follow_up_sent),
        aiSummary: conv.ai_summary ?? null,
        aiSummaryAt: conv.ai_summary_at ? new Date(String(conv.ai_summary_at)).toISOString() : null,
        aiSummaryModel: conv.ai_summary_model ? String(conv.ai_summary_model) : null,
